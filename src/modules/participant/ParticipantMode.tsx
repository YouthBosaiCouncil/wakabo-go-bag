...
const ParticipantMode: React.FC<Props> = ({
  info,
  setNotification,
  onSubmitted,
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (info.type === "lesson" && info.team) {
        ...
        const sessionCollection = info.sessionCollection ?? "trainingSessions";
